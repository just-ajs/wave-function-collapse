...
namespace WaveFunctionCollapse
{
    public class Pattern
    {
        ...
        public void InitializeListOfOverlappingNeighbours(List<Pattern> patternsFromSample)
        {
            ...
            // How many overlapping positions considering only edges without middle
            //var offsetsToConsiderWithoutMiddle = offsetsToConsider * 4 - 4;
            //var overlapDimensionWithoutMiddle = (int)Math.Sqrt(offsetsToConsiderWithoutMiddle);
